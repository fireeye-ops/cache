...
-- Proactively monitored $>$4500 servers, using Zabbix, in a small team for abnormal load, user abuse, hardware health, network connectivity and attacks, and broken configurations.\par
...
-- I moderate(d) the KoRx game servers and KoR community as well as set up events.\par
